...
./BioloidBeaglebone PRU_0.out PRU_1.out ./SupportingMaterial/MotionFiles/FlexTest.mtn ./SupportingMaterial/MLFiles/PersonDogCatBirdYOLO/voc.names ./SupportingMaterial/MLFiles/PersonDogCatBirdYOLO/yolov3-tiny_obj.cfg ./SupportingMaterial/MLFiles/PersonDogCatBirdYOLO/yolov3-tiny_obj_8000.weights;
